...
public static class CaptureTool
{
    ...
    public static CaptureResult Capture(Camera camera, TextureFormat textureFormat, string extension, int width, int height, bool clearBack, string directory, string file)
    {
        string outputDirectory;
        string outputFile;
        string outputExtension;
        ...
        try
        {
            Texture2D captureImage = Capture(camera, textureFormat, width, height, clearBack);
    ...
    public static Texture2D Capture(Camera camera, TextureFormat textureFormat, int width, int height, bool clearBack)
    {
        // NOTE:
        // Keep presets.
        ...
        captureImage = new Texture2D(width, height, textureFormat, false);
