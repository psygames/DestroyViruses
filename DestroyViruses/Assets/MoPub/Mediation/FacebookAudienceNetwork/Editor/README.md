## Overview
  * This folder contains the configuration files required to integrate with the FacebookAudienceNetwork SDK.
  * To install or upgrade the FacebookAudienceNetwork SDK, please use the [SDK Manager](https://developers.mopub.com/docs/unity/getting-started/#sdkmanager) in the [MoPub Menu](https://developers.mopub.com/docs/unity/menu/) within Unity.
